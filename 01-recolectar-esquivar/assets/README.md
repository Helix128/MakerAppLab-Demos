...
- `player_walk.png` → el jugador (tira animada de 4 cuadros).
- `enemy_spike.png` → los enemigos (tira animada de 4 cuadros).
- `gem.png` → los objetos a recolectar (tira animada de 4 cuadros).
- `bg_field.png` → el fondo. Es una **imagen fija** del tamaño del
  canvas (600×600). No es una tira: un solo cuadro que cubre todo.
...
Ya hay un sprite placeholder (`player_walk.png`). Para usar el tuyo:

1. Reemplaza `player_walk.png` por tu propio PNG (mismo nombre = no
